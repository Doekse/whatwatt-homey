...
class whatwattAPI {
  ...
  async getSystemInfo() {
    try {
      ...
      throw this._handleError('Failed to get system info', error);
    }
  }
  ...
  async getReport() {
    try {
      ...
      throw this._handleError('Failed to get meter report', error);
    }
  }
  ...
  async getLiveDataStream() {
    try {
      ...
      throw this._handleError('Failed to get live data stream', error);
    }
  }
  ...
  async getVariables() {
    try {
      ...
      throw this._handleError('Failed to get variables', error);
    }
  }
  ...
  async getSettings() {
    try {
      ...
      throw this._handleError('Failed to get settings', error);
    }
  }
  ...
  async updateSettings(settings) {
    try {
      ...
      throw this._handleError('Failed to update settings', error);
    }
  }
  ...
  async replaceSettings(settings) {
    try {
      ...
      throw this._handleError('Failed to replace settings', error);
    }
  }
  ...
  async getMeterSettings() {
    try {
      ...
      throw this._handleError('Failed to get meter settings', error);
    }
  }
  ...
  async updateMeterSettings(settings) {
    try {
      ...
      throw this._handleError('Failed to update meter settings', error);
    }
  }
  ...
  async getCurrentScalers() {
    try {
      ...
      throw this._handleError('Failed to get current scalers', error);
    }
  }
  ...
  async getCustomScalers() {
    try {
      ...
      throw this._handleError('Failed to get custom scalers', error);
    }
  }
  ...
  async setCustomScalers(scalers) {
    try {
      ...
      throw this._handleError('Failed to set custom scalers', error);
    }
  }
  ...
  async getWiFiSettings() {
    try {
      ...
      throw this._handleError('Failed to get WiFi settings', error);
    }
  }
  ...
  async updateWiFiSettings(settings) {
    try {
      ...
      throw this._handleError('Failed to update WiFi settings', error);
    }
  }
  ...
  async scanWiFiNetworks() {
    try {
      ...
      throw this._handleError('Failed to scan WiFi networks', error);
    }
  }
  ...
  async getEthernetSettings() {
    try {
      ...
      throw this._handleError('Failed to get Ethernet settings', error);
    }
  }
  ...
  async updateEthernetSettings(settings) {
    try {
      ...
      throw this._handleError('Failed to update Ethernet settings', error);
    }
  }
  ...
  async getMQTTSettings() {
    try {
      ...
      throw this._handleError('Failed to get MQTT settings', error);
    }
  }
  ...
  async updateMQTTSettings(settings) {
    try {
      ...
      throw this._handleError('Failed to update MQTT settings', error);
    }
  }
  ...
  async getPowerData() {
    try {
      ...
      throw this._handleError('Failed to get power data', error);
    }
  }
  ...
  _handleError(message, error) {
    if (error.response) {
      ...
      switch (status) {
        ...
        case 401:
          return new Error(`${message}: Unauthorized - Check credentials`);
        case 404:
